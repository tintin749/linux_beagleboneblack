...
@ -mlittle-endian -mfloat-abi=soft -mabi=aapcs-linux -mfpu=vfp -marm
@ -mtls-dialect=gnu -mlibarch=armv7-a -march=armv7-a
...
.ascii "->TSK_ACTIVE_MM #900 offsetof(struct task_struct, active_mm)"	@
@ 0 "" 2
...
.ascii "->TSK_STACK_CANARY #1016 offsetof(struct task_struct, stack_canary)"	@
@ 0 "" 2
...
@ 0 "" 2
@ arch/arm/kernel/asm-offsets.c:61:   DEFINE(TI_THUMBEE_STATE,	offsetof(struct thread_info, thumbee_state));
